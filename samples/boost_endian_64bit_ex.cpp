...
int main() {
    ...
    int64_t original_value = 0x0123456789ABCDEF;

    // Create a little-endian buffer
    boost::endian::little_int64_buf_t little_endian_value(original_value);

    // Create a big-endian buffer
    boost::endian::big_int64_buf_t big_endian_value(original_value);
